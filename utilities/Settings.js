export class Settings {
    constructor() {
        ...
        this._sites = ["xvideos_site", "xnxx_site", "xhamster_site", "tnaflix_site", "pornhub_site", "redtube_site", "tube8_site", "thumbzilla_site", "youporn_site"];
        // this._sites = ["youporn_site"];
    }
